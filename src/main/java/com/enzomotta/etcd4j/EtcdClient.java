...
public class EtcdClient {
	...
	public EtcdResponse get(String key) {
		...
		try {
			...
			if (response.getStatusLine().getStatusCode() == 200) {
				...
				if (entity != null) {
					result = parser.parseJSON(EntityUtils.toString(entity));
				}
			} else {
	 ...
	 */
	public EtcdResponse testAndSet(String key, String prevValue, String value) {
		return null;
	}
	...
	private EtcdResponse set0(String key, List<BasicNameValuePair> data,
